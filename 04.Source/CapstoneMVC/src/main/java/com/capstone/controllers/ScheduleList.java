    ...
    public JsonObject EditSchedule(@RequestParam Map<String, String> params) {
        ...
        try {
            ...
            for (String aSlotString : slots) {
                ...
                List<ScheduleEntity> scheduleEntities = new ArrayList<>();
                ScheduleEntity fromSchedule = scheduleService.findScheduleById(Integer.parseInt(params.get("scheduleId")));

                //fromSchedule
                scheduleEntities.add(fromSchedule);
...
//                            if (changedSchedule.getSubjectCode().equals("JLT301")) {
//                                System.out.println("");
//                            }
                RealSemesterEntity currentSemester = Global.getCurrentSemester();
                CourseEntity course = courseService.findCourseBySemesterAndSubjectCode(currentSemester.getSemester(), changedSchedule.getSubjectCode());
