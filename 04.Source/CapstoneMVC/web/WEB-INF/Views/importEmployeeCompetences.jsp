...
<section class="content">
    <div class="box">
        <div class="b-header">
            <h1>Nhập danh sách các môn GV có thể dạy</h1>
            <hr>
        </div>
        <div class="b-body">
            <div class="form-group">
                <div class="row">
                    <div class="title">
                        Bấm vào <a class="link" href="/Resources/FileTemplates/GiangVien-MonHoc.xlsx">Template</a>
                        để tải
                        về bản mẫu
                    </div>
                    <div class="title">
