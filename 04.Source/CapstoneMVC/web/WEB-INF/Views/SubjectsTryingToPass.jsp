...
<section class="content">
    <div class="box">
        <div class="b-header">
            <h1>Danh sách môn sinh viên cố gắng trả nợ</h1>
            <hr>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="table" class="cell-border">
                            ...
                            <tr>
                                <th>Mã sinh viên</th>
                                <th>Tên sinh viên môn</th>
                                <th>Số môn đang trả nợ</th>
                                <th>Môn sinh viên đang trả nợ</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
...
<script>
    ...
    function GetResult() {
        ...
        table = $('#table').DataTable({
            ...
            "bProcessing": true,
            "bSort": false,
            "sAjaxSource": "/subjectsTryingToPass", // url getData.php etc
