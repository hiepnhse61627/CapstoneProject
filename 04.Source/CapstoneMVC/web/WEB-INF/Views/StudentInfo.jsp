                                    ...
                                    <%--<div class="term-wrapper">--%>
                                        ...
                                        <%--<div class="marks">--%>
                                            ...
                                            <%--<div class="mark">--%>
                                                ...
                                                <%--<div class="medium-col text-left"><span>Lập trình blap</span></div>--%>
                                                <%--<div class="small-col"><span>3</span></div>--%>
                                                <%--<div class="small-col"><span>7.1</span></div>--%>
                                                <%--<div class="small-col"><span>Passed</span></div>--%>
                                            <%--</div>--%>
                                            <%--<div class="mark">--%>
                                                <%--<div class="small-col"><span>CSD201</span></div>--%>
                                                <%--<div class="medium-col text-left"><span>Hệ thống ảo</span></div>--%>
                                                <%--<div class="small-col"><span>3</span></div>--%>
                                                <%--<div class="small-col"><span>9.2</span></div>--%>
                                                <%--<div class="small-col"><span>Passed</span></div>--%>
                                            <%--</div>--%>
                                            <%--<div class="mark">--%>
                                                <%--<div class="small-col"><span>LOL200</span></div>--%>
                                                <%--<div class="medium-col text-left"><span>Liên minh huyền thoại</span>--%>
                                                <%--</div>--%>
                                                <%--<div class="small-col"><span>3</span></div>--%>
                                                <%--<div class="small-col"><span>6.9</span></div>--%>
                                                <%--<div class="small-col"><span>Passed</span></div>--%>
                                            <%--</div>--%>
                                            <%--<div class="mark">--%>
                                                <%--<div class="small-col"><span>CSD211</span></div>--%>
    ...
    function RenderMarkList(list) {
        ...
        for (var i = 0;  i < list.length; ++i) {
            ...
            for (var j = 0; j < markList.length; ++j) {
                ...
                html += "<div class='medium-col text-left'><span>" + mark.subjectName + "</span></div>";
                html += "<div class='small-col'><span>" + mark.credits + "</span></div>";
                html += "<div class='small-col'><span>" + mark.averageMark + "</span></div>";
                html += "<div class='small-col'><span>" + mark.status + "</span></div>";
                html += "</div>";
            }
            html += "</div></div>"
        }
